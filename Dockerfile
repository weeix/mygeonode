...
COPY src /usr/src/mygeonode/
WORKDIR /usr/src/mygeonode
...
RUN chmod +x /usr/src/mygeonode/tasks.py \
    && chmod +x /usr/src/mygeonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/mygeonode/entrypoint.sh
